...
/** Create a 3D Solar System and add it to passed scene */
function SolarSystem() {
  ...
  // Sun DATA: http://nssdc.gsfc.nasa.gov/planetary/factsheet/sunfact.html
  // create the Sun
  createSun();
  // load planets information and create Planets
  ...
  /** Create from JSON data planets object and add them to scene
   * @param response - a JSON object that have to contain planets data
   * */
